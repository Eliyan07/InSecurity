 ...
 * Centralizing icons prevents duplication and ensures consistency
 */
...
export const ChevronIcon: React.FC<IconProps & { open?: boolean }> = ({ size = 16, className, open }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const EmptyExclusionIcon: React.FC<IconProps> = ({ size = 48, className }) => (
